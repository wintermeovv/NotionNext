...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'no game no life', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wintercomes.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '冬之家', // 网站关键词 英文逗号隔开
